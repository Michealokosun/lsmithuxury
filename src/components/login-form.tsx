...
import bg from "../../src/assets/images/loginbg2.jpg";
...
export function LoginForm({
  ...
  const handlechange = (e: any) => {
    ...
    setuserdetails({ ...userdetials, [name]: value });
  };

  const handleSubmit = async (e: any) => {
    e.preventDefault();
    const user = await SignInUserWithEmail(userdetials);
    navigate("/");
  };
  return (
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <div className="p-6 md:p-8">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-balance text-sm text-muted-foreground">
                    Login to your smithFood Inc account
                  </p>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Button className="w-full outline-0 focus-visible:ring-0 ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
